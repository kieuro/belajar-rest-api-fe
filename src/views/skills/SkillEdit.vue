        ...
        <form class="max-w-md mx-auto p-4 bg-white shadow-md rounded-md" @submit.prevent="updateSkill($route.params.id)">
            <div class="space-y-6">
                <div class="mb-6">
                    ...
                    <input type="text" v-model="skill.name" id="name"
                ...
                <div class="mb-6">
                    <label for="slug" class="block mb-2 text-sm font-medium text-black">Slug</label>
                    <input type="text" v-model="skill.slug" id="slug"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
